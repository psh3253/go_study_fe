<template>
  ...
  <div class="d-flex justify-content-center">
    <div style="width: 80%">
      ...
      <p class="fw-bold h3 text-center mb-3">스터디 멤버</p>
      <div class="row row-cols-5 mb-4">
        <div class="col" v-for="participant in participants" :key="participant.id">
          <div class="card mx-1 my-1">
            <div class="d-flex justify-content-center">
              <img v-if="participant.image !== null" :src="participant.image" class="card-img-top rounded-circle mx-5 my-3" style="width: 50%; height: 50%" alt="">
              <img v-else :src="default_image_url" class="card-img-top rounded-circle mx-5 my-3" style="width: 50%; height: 50%" alt="">
            </div>
            <div class="card-body text-center">
              <h5 class="card-title"><svg v-if="participant.email === study.creatorEmail" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star-fill" viewBox="0 0 16 16">
                <path style="fill: gold" d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
              </svg>&nbsp;{{ participant.nickname }}</h5>
              <p class="card-text" style="height: 70px; overflow: hidden;	text-overflow: ellipsis;	display: -webkit-box;	-webkit-line-clamp: 4;	-webkit-box-orient: vertical;	word-wrap:break-word;">{{ participant.introduce }}</p>
            </div>
          </div>
        </div>
      </div>
