<template>
  ...
  <div class="d-flex">
    ...
    <div class="card mx-3 my-3" style="width: 400px; height: min-content">
      <img v-if="profile.image.startsWith('http')" :src=profile.image class="card-img-top" alt="">
      <img v-else :src="api_url + '/images/profile/' + profile.image" alt="">
      <div class="card-body">
        <h5 class="card-title">{{ profile.nickname }}</h5>
        <p class="card-text" style="height: 100px; overflow: hidden;	text-overflow: ellipsis;	display: -webkit-box;	-webkit-line-clamp: 4;	-webkit-box-orient: vertical;	word-wrap:break-word;">{{ profile.introduce }}</p>
      </div>
      <ul class="list-group list-group-flush">
        <li class="list-group-item h5">Email : {{ profile.email }}</li>
      </ul>
      <div class="card-body">
